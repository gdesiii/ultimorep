function [output1,output2,output3] = data_normalization(data)
...
for index=1 : 1 : 8
    ...
    if index>1
        ...
        time_vector=[time_vector; data_matrix(:,1)];
    end
end 
...
cell_time=mat2cell(time_vector,[length(cell2mat(data(1,1))) length(cell2mat(data(2,1))) length(cell2mat(data(3,1))) length(cell2mat(data(4,1))) length(cell2mat(data(5,1))) length(cell2mat(data(6,1))) length(cell2mat(data(7,1))) length(cell2mat(data(8,1)))] ,[1]  );
